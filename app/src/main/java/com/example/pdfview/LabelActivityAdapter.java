...
public class LabelActivityAdapter extends RecyclerView.Adapter<LabelActivityAdapter.LabelView> {
    Context context;
    List<LabelActivityModel> labelMasterModels;

    RecycleCheck recycleCheck;

    public LabelActivityAdapter(Context context, List<LabelActivityModel> labelMasterModels, RecycleCheck recycleCheck) {
        this.context = context;
        this.labelMasterModels = labelMasterModels;
        this.recycleCheck = recycleCheck;
    }

    public interface RecycleCheck
    {
    ...
    public LabelView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new LabelActivityAdapter.LabelView(view);
    }
    ...
    public void onBindViewHolder(@NonNull LabelView holder, final int position) {
        ...
        holder.remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(labelMasterModels.size()==0)
                {
                    recycleCheck.sendCheck(true);
                }
