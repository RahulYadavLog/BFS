...
public abstract class PDFCreatorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button buttonEmailVisit,btnDownload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDownload = layoutPrintPreview.findViewById(R.id.buttondownload);
    ...
    public void onClick(View v) {
        if (v == buttonNextPage) {
            ...
            try {
                onDownloadClicked(savedPDFFile);
    ...
    protected abstract void onDownloadClicked(File savedPDFFile) throws FileNotFoundException;
}
